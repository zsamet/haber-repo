...
Visual Studio aracılığıyla c# dilinde yazdığımız ve düzenlediğimiz ara yüz tasarımımıza giriş yaparak haberin AA formatında yazılmış halini hangi dilden çevrildiyse o dilden Türkçeye çevrilmiş halini iki tane dataGridView içine yerleştirdiğimiz  databaseler ile görüntüleyerek metinler arasında kıyaslama yapabilirsiniz.
